...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        @Html.HiddenFor(Function(model) model.MovieID)
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.DirectorName, htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.EditorFor(Function(model) model.DirectorName, New With { .htmlAttributes = New With { .class = "form-control" } })
                @Html.ValidationMessageFor(Function(model) model.DirectorName, "", New With { .class = "text-danger" })
            </div>
        </div>
